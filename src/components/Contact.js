...
export default function Contact() {
  return (
	...
	<div className='h-screen'>
	  <nav className="bg-slate-50 shadow-sm w-full h-[70px] flex justify-between items-center px-4 text-gray-800 font-serif">
          <a href="#">
		  ...
		  <div className='h-[100vh] md:mt-12 md:ml-20'>
			<div>
				<h1 className='text-3xl font-bold font-serif text-zinc-900 mb-3'>Contact Us</h1>
				<h2 className='text-neutral-900 font-thin text-md'>If you have any queries, please do not hesitate to contact us.</h2>
				<span className='text-slate-700'>Email:</span><a href="https://codeit.com.np/" className='text-slate-500'>info@codeit.com.np</a>
			</div>
      <div className='flex space-x-32'>
			<div className=' h-[380px] w-[45%] border-2  shadow-md rounded-2xl shadow-gray-300 mt-14 '>
				<h1 className='ml-8 mt-4 font-semibold text-2xl font-serif text-zinc-900'>Contact Us</h1>
