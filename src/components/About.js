  ...
  return (
    <>
      <div className='h-screen w-full'>
        <nav className="bg-slate-50 shadow-sm font-serif w-full h-[70px] flex justify-between items-center px-4 text-slate-800">
          <a href="#">
        ...
        <div className='relative'>
          ...
          <div className='absolute bottom-20 left-10 md:top-36 md:left-28 text-slate-300 font-serif'>
        ...
        <div className='md:ml-28 md:mt-10 md:mr-24'>
          <h1 className='font-semibold text-2xl text-zinc-900'>Why Choose Code IT?</h1>
          ...
          <h1 className='font-semibold mt-4 text-zinc-900'>Our Mission:</h1>
          <p className='font-normal text-gray-900'>
          ...
          <h1 className='font-semibold mt-2 text-zinc-900'>What Sets Us Apart:</h1>
          <h1 className='font-semibold mt-4 text-zinc-900'>1. Expert Instructors:</h1>
          <p className='font-normal text-gray-900'>
          ...
          <h1 className='font-semibold text-zinc-900'>2. Comprehensive Curriculum:</h1>
          <p className='font-normal text-gray-900'>
          ...
          <h1 className='font-semibold text-zinc-900'>3. Flexible Learning Options:</h1>
          <p className='font-normal text-gray-900'>
          ...
          <h1 className='font-semibold text-zinc-900'>4. Hands-On Projects:</h1>
          <p className='font-normal text-gray-900'>
          ...
          <h1 className='font-semibold text-zinc-900'>5. Career Guidance:</h1>
          <p className='font-normal text-gray-900'>
          ...
          <h1 className='font-semibold text-zinc-900'>6. Community Engagement:</h1>
          <p className='font-normal text-gray-900'>
        ...
        <footer className="p-2 md:px-8 text-black bg-indigo-50 flex flex-col pb-12 w-full h-auto pt-8 md:flex-row flex-wrap md:justify-between md:mt-16 relative">
          <div className="flex flex-col md:ml-20 text-zinc-950 font-extralight mb-8">
            <div className='mb-2'>
          ...
          <div className="flex flex-col md:items-center">
            ...
            <div className="border-b-2 w-24 h-1 border-orange-600"></div>
          ...
          <div className="flex flex-col md:items-center">
            ...
            <div className="border-b-2 w-32 h-1 border-yellow-600"></div>
